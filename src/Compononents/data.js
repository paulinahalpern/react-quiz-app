export function getQuestionByCategory(categoryName){
return questionQuiz.find(category=> category.title === categoryName);
}

export function getQuestionCategories(){
    return questionQuiz.map(category => category.title)
}
